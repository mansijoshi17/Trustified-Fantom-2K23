          ...
          <div className="col-lg-7">
            <div className="cta-one__content"> 
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  <i className="fa fa-check"></i>Availability: All the data will be stored on decentralised storage of the ipfs network.
                </li>
                <li>
                  <i className="fa fa-check"></i>Forgery Proof: Each certificate and badge will be an NFT on the Fantom blockchain.
                </li>
                <li>
